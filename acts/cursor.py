...
# --- CAMBIO 1: DETECTAR TAMAÑO DE TU PANTALLA AUTOMÁTICAMENTE ---
...
# --- CAMBIO 2: SENSIBILIDAD ---
# Aumenta este valor si quieres mover menos la mano. (Antes era 100)
X_Y_INI = 150 
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                # Mapeo de coordenadas corregido a pantalla completa
                ...
                # Pasamos width, height y output a la función corregida
